"""
Django settings for privatecar_39790 project.
...
ROOT_URLCONF = 'privatecar_39790.urls'
...
WSGI_APPLICATION = 'privatecar_39790.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "privatecar_39790 API",
    "DESCRIPTION": "API documentation for privatecar_39790 App",
    "VERSION": "v1",
}
